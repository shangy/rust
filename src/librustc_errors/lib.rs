...
use emitter::{EmitterDyn, EmitterWriter};

use rustc_data_structures::sync::{Lrc, Lock, LockCell};
...
pub type CodeMapperDyn = CodeMapper;
...
impl Handler {
    ...
    pub fn with_emitter_and_flags(e: Box<EmitterDyn>, flags: HandlerFlags) -> Handler {
        Handler {
            flags,
